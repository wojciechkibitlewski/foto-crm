<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        <nav class="w-full rounded-md">
            <ol class="list-reset flex">
                ...
                <li>
                    <x-link-breadcrumb :message="__('Kategorie produktu')" :href="route('settings.productcategory.index')" />
                </li>
                <li>
                    <x-slash-breadcrumb />
                </li>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-3xl text-gray-800 leading-tight m-4">
            {{ __('Produkty. Edytowanie kategorii produktu') }}
        </h2>
    </x-slot>
    ...
    <div class="w-full">
        ...
        <div class="flex flex-col pr-4 md:mr-4 pb-[120px]">
            <div class="md:flex md:flex-row md:justify-between my-4">
                ...
                <div>
                    <x-link-back :message="__('Back')" :href="route('settings.productcategory.index')"/>
                </div>
            </div>
            ...
            dark:bg-neutral-700">
                <form action="{{ route('settings.productcategory.update') }}" method="POST">
                    ...
                    <div class="relative mb-6" data-te-input-wrapper-init>
                        ...
                        id="category" name="category" value="{{ $productcategory->category }}"  />
                        <label for="category"
