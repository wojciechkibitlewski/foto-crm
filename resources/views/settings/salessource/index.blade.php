    ...
    <div class="w-full">
        ...
        <div class="flex flex-col pr-4 md:mr-4 pb-[120px]">
            ...
            <div class="md:flex md:flex-row md:justify-between my-4">
                ...
                <div>
                    <x-link-add :message="__('Create sources')" :href="route('settings.salessource.create')"/>
                </div>
            </div>
                    ...
                    <table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
                        <thead class="text-white">
                            ...
                            <tr class="bg-teal-400 flex flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">
                                ...
                                <th scope="col" class="p-3 text-left">Source</th>
                    ...
                    <tbody class="flex-1 sm:flex-none">
                        @foreach ($sources as $item)
                            <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                                ...
                                <td class="border-grey-light border hover:bg-gray-100 p-3">{{ $item->source }}</td>
                                ...
                                <td class="border-grey-light border hover:bg-gray-100 p-2">
                                    <form action="{{ route('settings.salessource.destroy',$item->id) }}" method="POST">
                                        <a class="p-1 px-3 bg-sky-200 rounded mr-2" href="{{ route('settings.salessource.show',$item->id) }}">Show</a>
                                        <a class="p-1 px-3 bg-emerald-200 rounded mr-2" href="{{ route('settings.salessource.edit',$item->id) }}">Edit</a>
