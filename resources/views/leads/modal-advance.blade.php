...
<div
  ...
  id="addAdvanceModal"
  tabindex="-1"
  aria-labelledby="addAdvanceModalLabel"
  aria-hidden="true">
  ...
  <div
    ...
    <div
      ...
      <div class="relative flex-auto p-4" data-te-modal-body-ref>
        <!-- -->
        <div class="mb-4">
            <x-input-label for="advanceValue" :value="__('Zaliczka')" />
            <x-text-input id="advanceValue" class="block mt-1 w-full " type="text" 
            name="advanceValue" :value="old('advanceValue')" 
            autofocus />
            <x-input-error :messages="$errors->get('advanceValue')" class="mt-2" />
        </div>
